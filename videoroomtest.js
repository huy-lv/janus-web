...
if (window.location.protocol === "http:")
  server = "http://teachild.ga:8088/janus";
else server = "https://teachild.ga:8089/janus";
  ...
  Janus.init({
    ...
    callback: function() {
      ...
      $("#start").one("click", function() {
        ...
        janus = new Janus({
          server: server,
          iceServers: [{urls: "turn:teachild.ga:3478", username: "test", credential: "test"},
                        {urls: "stun:teachild.ga:3478"}],
          success: function() {
